...
export default function WhatsAppButton() {
  ...
  const message = isAr
    ? 'مرحباً، أرغب في الاستفسار عن أحجاركم الطبيعية'
    : "Hello, I'd like to inquire about your natural stones";
  ...
  return (
    <a
      ...
      aria-label={isAr ? 'تواصل معنا على واتساب' : 'Contact us on WhatsApp'}
